...
Codex will:
1. Execute: `codex exec -m gpt-5.1 -s read-only -c model_reasoning_effort=high "Design a REST API..."`
...
Codex will:
1. Execute: `codex exec resume --last "Add comprehensive error handling to the API"`
